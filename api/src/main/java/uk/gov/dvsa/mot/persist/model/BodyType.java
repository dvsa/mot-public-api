...
/**
 * The persistent class for the body_type database table.
 */
public class BodyType implements Serializable {
   ...
   * getModelDetails().add( modelDetail ); modelDetail.setBodyType( this );
   * 
   * return modelDetail; }
   * 
   * public ModelDetail removeModelDetail( ModelDetail modelDetail ) {
   * getModelDetails().remove( modelDetail ); modelDetail.setBodyType( null );
   * 
   * return modelDetail; }
   */
}