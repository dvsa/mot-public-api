...
public class MotTestReadDaoMySQLJDBC implements MotTestReadDao
{
  private final SimpleDateFormat sdfDate = new SimpleDateFormat( "yyyy.MM.dd" ) ;
  private final SimpleDateFormat sdfDateTime = new SimpleDateFormat( "yyyy.MM.dd HH:mm:ss" ) ;
  private static final Logger logger = Logger.getLogger( MotTestReadDaoMySQLJDBC.class ) ;
  private final Connection connection ;
  private final Map<Long, MotTest> mMotTest = new HashMap<>() ;

  public MotTestReadDaoMySQLJDBC( Connection connection )
  {
  ...
  public List<MotTest> getMotTestCurrentsByVehicleId( int vehicleId )
  {
    ...
    List<MotTest> lMotTest = new ArrayList<>() ;
  ...
  public List<MotTest> getMotTestsByDateRange( Date startDate, Date endDate )
  {
    ...
    List<MotTest> lMotTest = getMotTestCurrentsByDateRange( startDate, endDate ) ;
    lMotTest.addAll( getMotTestHistorysByDateRange( startDate, endDate ) ) ;

    logger.debug( "Exit getMotTestsByDateRange : " + startDate + " - " + endDate + " found " + lMotTest.size() ) ;
    return lMotTest ;
  }
  ...
  public List<MotTest> getMotTestCurrentsByDateRange( Date startDate, Date endDate )
  {
    ...
    logger
        .debug( "Exit getMotTestCurrentsByDateRange : " + startDate + " - " + endDate + " found " + lMotTest.size() ) ;
    return lMotTest ;
  }
  ...
  public List<MotTest> getMotTestHistorysByDateRange( Date startDate, Date endDate )
  {
    ...
    logger
        .debug( "Exit getMotTestHistorysByDateRange : " + startDate + " - " + endDate + " found " + lMotTest.size() ) ;
    return lMotTest ;
  }
  ...
  public List<DisplayMotTestItem> getMotHistoryByDateRange( Date startDate, Date endDate )
  {
    ...
    List<DisplayMotTestItem> lMotHistory = getMotHistoryCurrentByDateRange( startDate, endDate ) ;
    lMotHistory.addAll( getMotHistoryHistoryByDateRange( startDate, endDate ) ) ;

    logger.debug( "Exit getMotHistoryByDateRange : " + startDate + " - " + endDate + " found " + lMotHistory.size() ) ;
    return lMotHistory ;
  }
  ...
  public List<DisplayMotTestItem> getMotHistoryCurrentByDateRange( Date startDate, Date endDate )
  {
    ...
    List<DisplayMotTestItem> lMotHistory ;
    ...
    try ( PreparedStatement stmt = connection.prepareStatement( MotTestReadSql.QueryGetMotHistoryCurrentVehicleByDateRange ) )
    {
      ...
      try ( ResultSet resultSet = stmt.executeQuery() )
      {
        lMotHistory = mapResultSetToDisplayMotTestItem( resultSet ) ;
      }
    }
    catch ( SQLException e )
    {
    ...
    logger.debug( "Exit getMotHistoryCurrentByDateRange : " + startDate + " - " + endDate + " found " + lMotHistory.size() ) ;
    return lMotHistory ;
  }
  ...
  public List<DisplayMotTestItem> getMotHistoryHistoryByDateRange( Date startDate, Date endDate )
  {
    ...
    logger.debug( "Exit getMotTestHistorysByDateRange : " + startDate + " - " + endDate + " found " + lMotHistory.size() ) ;
    return lMotHistory ;
  }
  ...
  {
    List<MotTest> lMotTestCurrent = new ArrayList<>() ;
    ...
    try ( PreparedStatement stmt = connection.prepareStatement( MotTestReadSql.queryGetMotTestCurrentsByIdRange ) )
    {
      ...
      try ( ResultSet resultSet = stmt.executeQuery() )
      {
        while ( resultSet.next() )
        {
          ...
          lMotTestCurrent.add( motTestCurrent ) ;
        }
      }
    }
    catch ( SQLException e )
  ...
  {
    List<MotTestRfrMap> lMotTestCurrentRfrMap = new ArrayList<>() ;
        ...
        .prepareStatement( MotTestReadSql.queryGetMotTestCurrentRfrMapsByMotTestId ) )
    {
      ...
      try ( ResultSet resultSet = stmt.executeQuery() )
      {
        while ( resultSet.next() )
        {
          ...
          lMotTestCurrentRfrMap.add( motTestCurrentRfrMap ) ;
        }
      }
    }
    catch ( SQLException e )
    ...
    return lMotTestCurrentRfrMap ;
  }

  @Override
  public List<MotTestRfrMap> getMotTestHistoryRfrMapsByMotTest( MotTest motTestCurrent )
  {
    List<MotTestRfrMap> lMotTestHistoryRfrMap = new ArrayList<>() ;
        ...
        .prepareStatement( MotTestReadSql.queryGetMotTestHistoryRfrMapsByMotTestId ) )
    {
      ...
      try ( ResultSet resultSet = stmt.executeQuery() )
      {
        ...
        {
          MotTestRfrMap motTestCurrentRfrMap = mapResultSetToMotTestCurrentRfrMap( motTestCurrent, resultSet ) ;
          lMotTestHistoryRfrMap.add( motTestCurrentRfrMap ) ;
        }
      }
    }
    catch ( SQLException e )
  ...
  {
    List<RfrLanguageContentMap> lRfrLanguageContentMap = new ArrayList<>() ;
      ...
      try ( ResultSet resultSet = stmt.executeQuery() )
      {
        while ( resultSet.next() )
        {
          RfrLanguageContentMap rfrLanguageContentMap = mapResultSetToRfrLanguageContentMap( reasonForRejection,
              resultSet ) ;
          lRfrLanguageContentMap.add( rfrLanguageContentMap ) ;
        }
      }
    }
    catch ( SQLException e )
  ...
  {
    List<TiCategoryLanguageContentMap> lTiCategoryLanguageContentMap = new ArrayList<>() ;
        ...
        .prepareStatement( MotTestReadSql.queryGetTiCategoryLanguageContentMapByTestItemCategory ) )
    {
      ...
      try ( ResultSet resultSet = stmt.executeQuery() )
      {
        while ( resultSet.next() )
        {
          ...
          lTiCategoryLanguageContentMap.add( tiCategoryLanguageContentMap ) ;
        }
      }
    }
    catch ( SQLException e )
    ...
    return lTiCategoryLanguageContentMap ;
  }
  ...
  {
    String szQuery = "select l from MotTestRfrLocationType l where l.lateral = :lateral and l.longitudinal = :longitudinal and l.vertical = :vertical " ;
   ...
   * 
   * @param resultSet
   *          the ResultSet with the right columns in from an MOT test query
   * @return A list of MOTs suitable for display, one for each row of the result
   *         set which has a unique test ID. If multiple MOT tests have the same
   *         ID in the result set, only the first is returned.
   */
  private List<DisplayMotTestItem> mapResultSetToDisplayMotTestItem( ResultSet resultSet )
  {
    List<DisplayMotTestItem> lDisplayMotTestItem = new ArrayList<>() ;
...
//      vehilce.id not used
        ...
        if ( currMotTestId != motTestId )
        {
          ...
          displayMotTestItem.setRfrAndComments( lRfrAndAdvisoryItem ) ;
          lDisplayMotTestItem.add( displayMotTestItem ) ;
            
          displayMotTestItem.setRegistration( resultSet.getString( 4 ) ) ;
          displayMotTestItem.setMake_name( resultSet.getString( 5 ) ) ;
          displayMotTestItem.setModel_name( resultSet.getString( 6 ) ) ;
          if ( resultSet.getDate( 7 ) != null )
          {
            displayMotTestItem.setFirst_used_date( sdfDate.format( resultSet.getTimestamp( 7 ) ) ) ;
          }
          displayMotTestItem.setFuel_type( resultSet.getString( 8 ) ) ;
          displayMotTestItem.setPrimary_colour( resultSet.getString( 9 ) ) ;
          // secondary colour not used
          // started date not used
          if ( resultSet.getDate( 12 ) != null )
          {
            displayMotTestItem.setCompleted_date( sdfDateTime.format( resultSet.getTimestamp( 12 ) ) ) ;
          }
          displayMotTestItem.setTest_result( resultSet.getString( 13 ) ) ;
          if ( resultSet.getDate( 14 ) != null )
          {
            displayMotTestItem.setExpiry_date( sdfDate.format( resultSet.getTimestamp( 14 ) ) ) ;
          }
          displayMotTestItem.setOdometer_value( String.valueOf( resultSet.getInt( 15) ) ) ;
          displayMotTestItem.setOdometer_unit( resultSet.getString( 16 ) ) ;
          // odometer result type not used
          displayMotTestItem.setMot_test_number( String.valueOf( resultSet.getBigDecimal( 18 ) ) ) ;
        }
  ...
  private MotTestRfrMapCustomDescription mapResultSetToMotTestRfrMapCustomDescription( MotTestRfrMap parent,
      ResultSet resultSet )
  {
    try
    {
  ...
  private TiCategoryLanguageContentMap mapResultSetToTiCategoryLanguageContentMap( TestItemCategory parent,
      ResultSet resultSet )
  {
    try
    {
