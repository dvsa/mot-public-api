...
public class VehicleReadDaoMySQLJDBC implements VehicleReadDao
{
  private static final Logger logger = Logger.getLogger( VehicleReadDaoMySQLJDBC.class ) ;
  private final Connection connection ;

  public VehicleReadDaoMySQLJDBC( Connection connection )
  {
