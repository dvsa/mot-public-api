...
public class TradeReadDaoMySQLJDBC extends AbstractDaoJDBC implements TradeReadDao
{
  @Inject
  public TradeReadDaoMySQLJDBC( ConnectionFactory connectionFactory )
  {
  ...
  public List<Vehicle> getVehiclesMotTestsByVehicleId( int vehicleId )
  {
    ...
    try ( Connection connection = getConnection() )
    {
          ...
          .prepareStatement( TradeReadSql.QUERY_GET_VEHICLES_MOT_TESTS_BY_VEHICLE_ID ) )
      {
        ...
        {
          lVehicle = ResultSetToVehicleMapper.mapResultSetToVehicle( resultSet ) ;
        }
      }
    }
    ...
    logger.debug( "Exit getMotHistoryByVehicleId : " + vehicleId + " found " + lVehicle.size() ) ;
    return lVehicle ;
  }
  ...
  public List<Vehicle> getVehiclesMotTestsByMotTestNumber( long number )
  {
    ...
    logger.debug( "Exit getVehiclesMotTestsByMotTestNumber : " + number + " found " + lVehicle.size() ) ;
    return lVehicle ;
  }
  ...
  public List<Vehicle> getVehiclesMotTestsByRegistrationAndMake( String registration, String make )
  {
    ...
    logger.debug( "Prepare getVehiclesMotTestsByRegistrationAndMake : " + registration + " " + make + " found "
        + lVehicle.size() ) ;
    return lVehicle ;
  }
  ...
  public List<Vehicle> getVehiclesMotTestsByDateRange( Date startDate, Date endDate )
  {
    ...
    logger.debug( "Exit getMotHistoryByDateRange1 : " + startDate + " - " + endDate + " found " + lVehicle.size() ) ;
    return lVehicle ;
  }
  ...
  public List<Vehicle> getVehiclesMotTestsByRange( int startVehicleId, int endVehicleId )
  {
    ...
    logger.debug(
        "Exit getMotHistoryByRange1 : " + startVehicleId + " - " + endVehicleId + " found " + lVehicle.size() ) ;
    return lVehicle ;
  }
