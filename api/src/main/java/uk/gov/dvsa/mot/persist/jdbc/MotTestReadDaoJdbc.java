...
public class MotTestReadDaoJdbc implements MotTestReadDao {
    ...
    public MotTest getMotTestCurrentById(long id) {
        ...
        ResultSetMapper<MotTest> mapper = new MotTestCurrentMapper();
    ...
    public MotTest getMotTestHistoryById(long id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTest> mapper = new MotTestHistoryMapper();
    ...
    public List<DisplayMotTestItem> getMotHistoryCurrentByDateRange(Date startDate, Date endDate) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<List<DisplayMotTestItem>> mapper = new DisplayMotTestItemMapper();

        return runner.executeQuery(MotTestReadSql.QueryGetMotHistoryCurrentVehicleByDateRange, mapper, startDate, endDate);
    }
    ...
    public List<DisplayMotTestItem> getMotHistoryHistoryByDateRange(Date startDate, Date endDate) {
        ...
        return runner.executeQuery(MotTestReadSql.QueryGetMotHistoryHistoryVehicleByDateRange, mapper, startDate, endDate);
    }
    ...
    public MotTestAddressComment getMotTestCurrentAddressCommentByMotTest(MotTest parent) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestAddressComment> mapper = rs -> {
    ...
    public MotTestCancelled getMotTestCancelledByMotTest(MotTest parent) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestCancelled> mapper = rs -> {
    ...
    public MotTestComplaintRef getMotTestComplaintRefByMotTest(MotTest parent) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestComplaintRef> mapper = rs -> {
    ...
    public MotTestEmergencyReason getMotTestEmergencyReasonByMotTest(MotTest parent) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestEmergencyReason> mapper = rs -> {
    ...
    public Comment getCommentById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<Comment> mapper = rs -> {
    ...
    public MotTestReasonForCancelLookup getMotTestReasonForCancelLookupById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestReasonForCancelLookup> mapper = rs -> {
    ...
    public EmergencyLog getEmergencyLogById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<EmergencyLog> mapper = rs -> {
    ...
    public EmergencyReasonLookup getEmergencyReasonLookupById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<EmergencyReasonLookup> mapper = rs -> {
    ...
    public List<MotTestRfrMap> getMotTestCurrentRfrMapsByMotTest(MotTest motTestCurrent) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestRfrMap> mapper = new MotTestRfrMapMapper(motTestCurrent);
    ...
    public MotTestRfrMapComment getMotTestRfrMapCommentByMotTestRfrMap(MotTestRfrMap parent) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestRfrMapComment> mapper = rs -> {
    ...
    public MotTestRfrMapCustomDescription getMotTestRfrMapCustomDescriptionByMotTestRfrMap(MotTestRfrMap parent) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestRfrMapCustomDescription> mapper = rs -> {
    ...
    public ReasonForRejection getReasonForRejectionById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<ReasonForRejection> mapper = rs -> {
    ...
    public List<RfrLanguageContentMap> getRfrLanguageContentMapByReasonForRejection(
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<RfrLanguageContentMap> mapper = rs -> {
    ...
    public ReasonForRejectionType getReasonForRejectionTypeById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<ReasonForRejectionType> mapper = rs -> {
    ...
    public MotTestRfrLocationType getMotTestRfrLocationTypeById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestRfrLocationType> mapper = rs -> {
    ...
    public TestItemCategory getTestItemCategoryById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<TestItemCategory> mapper = rs -> {
    ...
    public List<TiCategoryLanguageContentMap> getTiCategoryLanguageContentMapByTestItemCategory(
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<TiCategoryLanguageContentMap> mapper = rs -> {
    ...
    public LanguageType getLanguageTypeById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<LanguageType> mapper = rs -> {
    ...
    public BusinessRule getBusinessRuleById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<BusinessRule> mapper = rs -> {
    ...
    public BusinessRuleType getBusinessRuleTypeById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<BusinessRuleType> mapper = rs -> {
    ...
    public Person getPersonById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<Person> mapper = rs -> {
    ...
    public Organisation getOrganisationById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<Organisation> mapper = rs -> {
    ...
    public Site getSiteById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<Site> mapper = rs -> {
            Site site = new Site();
    ...
    public JasperDocument getJasperDocumentById(long id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<JasperDocument> mapper = rs -> {
    ...
    public MotTestType getMotTestTypeById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestType> mapper = rs -> {
    ...
    public MotTestStatus getMotTestStatusById(int id) {
        ...
        DbQueryRunner runner = new DbQueryRunnerImpl(connectionManager.getConnection());
        ResultSetMapper<MotTestStatus> mapper = rs -> {
    ...
    private class DisplayMotTestItemMapper implements ResultSetMapper<List<DisplayMotTestItem>> {

        @Override
        public List<DisplayMotTestItem> map(ResultSet rs) throws SQLException {
    ...
    private class MotTestCurrentMapper implements ResultSetMapper<MotTest> {

        @Override
        public MotTest map(ResultSet rs) throws SQLException {
    ...
    private class MotTestHistoryMapper implements ResultSetMapper<MotTest> {

        @Override
        public MotTest map(ResultSet rs) throws SQLException {

            MotTest motTest = new MotTestCurrentMapper().map(rs);
    ...
    private class MotTestRfrMapMapper implements ResultSetMapper<MotTestRfrMap> {

        private MotTest parent;

        public MotTestRfrMapMapper(MotTest parent) {

            this.parent = parent;
        }

        @Override
        public MotTestRfrMap map(ResultSet rs) throws SQLException {
