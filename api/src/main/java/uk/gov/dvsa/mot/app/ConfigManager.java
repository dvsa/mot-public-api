...
public class ConfigManager
{
   ...
   * @return The value of the environment variable, decrypted through KMS if the
   *         environment variable name has "ENCRYPTED" in it.
   * @throws IOException
   *           if a connection to KMS was attempted and failed
   */
   ...
   * @throws IOException
   *           If there is an error with the resource stream.
   */
